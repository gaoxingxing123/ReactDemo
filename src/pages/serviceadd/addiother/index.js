...
class AddOhter extends Component {
  ...
  componentDidMount(){
    ...
    let url='http://192.168.3.236:8088/businessDetails?loanId='+this.props.match.params.id+'&type=1'
    axios.get(url    
    ).then((res)=>{
        ...
        return (
            ...
            <div key={this.props.location.key}>
                <Menu
                                ...
                                <Menu.Item key="2"> 个人贷款信息 </Menu.Item>
...
const AddIOther = Form.create()(AddOhter);
...
export default connect(mapState,null) (AddIOther);